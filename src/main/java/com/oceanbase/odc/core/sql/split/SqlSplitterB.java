...
public class SqlSplitterB {
    ...
    public SqlSplitterB(Class<? extends Lexer> lexerType) {
        this(lexerType, DEFAULT_SQL_DELIMITER);
    }

    public SqlSplitterB(Class<? extends Lexer> lexerType, String delimiter) {
        this(lexerType, delimiter, true);
    }

    public SqlSplitterB(Class<? extends Lexer> lexerType, String delimiter, boolean addDelimiter) {
    ...
    private static class SqlSplitterIterator implements SqlStatementIterator {
        ...
        private OffsetString parseNext() {
            try {
                ...
                while (this.holder.isEmpty() && (line = this.reader.readLine()) != null) {
                    ...
                    SqlSplitterB splitter = createSplitter();
        ...
        private SqlSplitterB createSplitter() {
            return new SqlSplitterB(lexerType, this.delimiter, addDelimiter);
        }
